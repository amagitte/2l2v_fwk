...
MODELS=["MELA"] #,"RsGrav","BulkGrav","Rad"] #Models which can be used are: "RsGrav", "BulkGrav", "Rad", "SM"
based_key="2l2v_mcbased_" #to run limits on MC use: 2l2v_mcbased_, to use data driven obj use: 2l2v_datadriven_
jsonPath='$CMSSW_BASE/src/UserCode/llvv_fwk/test/hzz2l2v/samples_ichep2016_MELA_UsingSF.json'
inUrl='$CMSSW_BASE/src/UserCode/llvv_fwk/test/hzz2l2v/plotter_2016_11_23_nVtx_usingSF.root'
...
SUBMASS = [200, 300, 350, 400, 450, 500, 550, 600, 650, 700, 750, 800, 850, 900, 950, 1000, 1100, 1200, 1300, 1400, 1500]#, 1600, 1700, 1800, 1900, 2000, 2250, 2500]

#LandSArgCommonOptions=" --blind  --rebin 8 --dropBckgBelow 0.00001 "
LandSArgCommonOptions="  --BackExtrapol --statBinByBin 0.00001 --dropBckgBelow 0.00001  --subNRB --blind --closure"
...
for signalSuffix in signalSuffixVec : 
   ...
   ######################################################################
      ...
      os.system("root -l -b -q plotLimit.C+'(\""+DataCardsDir+"/Stength_\",\""+DataCardsDir+"/LimitTree.root\",\"\",  true, false, 13 , 12891.401 )'")
